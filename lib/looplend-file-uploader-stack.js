...
class LooplendFileUploaderStack extends Stack {
  constructor(scope, id, props) {
    ...
    uploadResource.addMethod('POST', new apigateway.LambdaIntegration(createUploadHandler(bucket.bucketName)), {
      authorizer: new apigateway.TokenAuthorizer(this, 'authorizer', {
        handler: authorizer,
